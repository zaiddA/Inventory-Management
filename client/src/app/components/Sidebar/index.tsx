...
import { Archive, Layout, Menu, SlidersHorizontal, User, Clipboard, CircleDollarSign } from "lucide-react";
    ...
    return (
        <div className={sidebarClassNames}>
            ...
            <div className={`${isSidebarCollapsed ? "hidden": "block"} mb-10`}>
                <p className="text-center text-xs text-gray-600">&copy;2025 Invotech</p>
            </div>
        </div>
    );
}
