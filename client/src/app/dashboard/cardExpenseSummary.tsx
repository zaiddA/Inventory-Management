...
const CardExpenseSummary=()=>{
    ...
    const expenseByCatergorySummary=dashboardMetrics?.expenseByCategorySummary || [];
                     ...
                     {/* Charts */}
                      <div className="relative basis-3/5">
                        <ResponsiveContainer width="100%" height={140}>
                           <PieChart>
                              <Pie data={expenseCategories}  innerRadius={50} outerRadius={60} fill="#8884d8" dataKey="value"
